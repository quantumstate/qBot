...
var MilitaryAttackManager = function() {
	...
	// "units/{civ}_infantry_archer_b", // TODO: should only include this if
	// hele
	];
};
...
MilitaryAttackManager.prototype.update = function(gameState, queues) {
	...
	planGroups.militaryPersonnel.addPlan(100, new UnitTrainingPlan(gameState, this.findBestNewUnit(gameState), 5, {
		"role" : "attack-pending"
	}));
