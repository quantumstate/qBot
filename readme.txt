...
Install by placing the files into the data/mods/public/simulation/ai/qbot folder NOTE:you must use a folder called qbot or it will not find some essential modules.
